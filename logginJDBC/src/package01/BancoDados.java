...
public class BancoDados implements InterfaceBancoDados {
	...
	public static void main(String[] args) throws IOException {
        ...
        switch(numberSelected){
            ...
            case 1:
            	meuLogger.logger.info("\n Iniciando a operação de inserção no banco");   
                String name;
                String email;
                ...
                return;
            case 2:
            	meuLogger.logger.info("\n Iniciando a operação de update no banco");   
            ...
            case 3:
            	meuLogger.logger.warning("\n Iniciando a operação de delete no banco");   
                bd.consultar(query_consulta);
            ...
            case 4:
            	meuLogger.logger.info("\n Iniciando a operação de consulta no banco");   
                bd.consultar(query_consulta);

            case 5:
            	meuLogger.logger.info("\n Iniciando a operação de desconexão no banco");   
                bd.desconectar();
    ...
    public void conectar(String db_url, String db_user, String db_password){
        ...
        try {
            ...
            meuLogger.logger.warning("\n Realizado a conexão do banco com sucesso! ");  
   ...
   @Override
    public void desconectar() {
        try {
            ...
            meuLogger.logger.warning("\n Realizado a desconexão do banco com sucesso! ");  
        } catch (SQLException e) {
    ...
    public int inserirAlterarExcluir(String db_query) {
        ...
        try {
            ...
            meuLogger.logger.severe("\n Não foi possível executar a operação de inserção/alteração/exclusão no banco de dados ");  
            e.printStackTrace();
        }
        System.out.println(rowsAffected + " linha foi afetada.");
        meuLogger.logger.warning("\n" + rowsAffected + "linha foi afetada. ");
        return rowsAffected;
    }
    }
